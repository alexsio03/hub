            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                      ...
                      <div className="py-1">
                        <Menu.Item>
                          {({ disabled }) => (
                            ...
                            >
                              {user ? <>Current User: {user.displayName}</> : loading ? <>Loading...</> : <button onClick={signIn}>Login</button>}  
                            </p>
                          )}
                        </Menu.Item>
                      </div>
                ...
                : <a className="flex ml-auto mr-10 px-3 py-2 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 flex-row">
                  {loading ? <p className='py-2'>Loading...</p> : <button onClick={signIn}>Login</button>}</a>}
              </div>
            </div>
          </div>
